...
cp .env.example .env
#    יש לפתוח את .env ולמלא SESSION_SECRET ו-WEATHER_API_KEY

# 3. הזרעת נתוני הדגמה (500 כתבות, משתמשים, תגובות ונתוני צפייה)
npm run seed

# 4. הרצת השרת
npm start          # או: npm run dev  (טעינה מחדש אוטומטית)
```
